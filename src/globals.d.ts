...
declare global {
    ...
    export var CometCordNative: typeof import("./CometCordNative").default;
    export var CometCord: typeof import("./CometCord");
    export var CometCordStyles: Map<string, Style>;
