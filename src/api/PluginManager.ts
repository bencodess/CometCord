...
import { FluxEvents } from "@CometCord/discord-types";
...
export function addPatch(newPatch: Omit<Patch, "plugin">, pluginName: string, pluginPath = `CometCord.Plugins.plugins[${JSON.stringify(pluginName)}]`) {
