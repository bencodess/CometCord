...
import { Command, FluxEvents } from "@CometCord/discord-types";
...
export interface PluginDef {
    ...
    /**
     * Allows you to add custom actions to the CometCord Toolbox.
     *
...
export const enum StartAt {
    /** Right away, as soon as CometCord initialised */
    Init = "Init",
...
> {
    /** Shorthand for `CometCord.Settings.plugins.PluginName`, but with typings */
    store: SettingsStore<Def> & PrivateSettings;
    /** Shorthand for `CometCord.PlainSettings.plugins.PluginName`, but with typings */
