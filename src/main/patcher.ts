...
console.log("[CometCord] Starting up...");
...
if (!IS_VANILLA) {
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "CometCord");
    ...
    console.log("[CometCord] Running in vanilla mode. Not loading CometCord");
}

console.log("[CometCord] Loading original Discord app.asar");
