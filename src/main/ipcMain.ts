...
const RENDERER_CSS_PATH = join(__dirname, IS_VESKTOP ? "CometCordDesktopRenderer.css" : "renderer.css");
...
ipcMain.handle(IpcEvents.OPEN_MONACO_EDITOR, async () => {
    const title = "CometCord QuickCSS Editor";
    ...
    const win = new BrowserWindow({
        ...
        darkTheme: true,
        webPreferences: {
            preload: join(__dirname, IS_DISCORD_DESKTOP ? "preload.js" : "CometCordDesktopPreload.js"),
